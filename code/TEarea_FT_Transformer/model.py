...
from Fre_Time_FuseTransformer import *
...
def fourier_transform(x):
    ...
    # output = np.fft.fft2(output, axes=(-1, -2)).real
...
class FNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # depthwise_conv
        # output = self.depthwise_conv(encoder_layer).squeeze(1)
        # classify
...
class Transformer(nn.Module):
    def __init__(self):
        ...
        self.classification = ClassificationHead(d_model, 40)
    ...
    def forward(self, fre_enc_inputs, time_enc_inputs):
        ...
        res_output = self.classification(enc_FT_outputs)
        return res_output, FT_self_attens
