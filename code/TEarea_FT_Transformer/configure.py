...
class default_config(object):
    def __init__(self):
        self.gpu = 1
        self.eeg_dataset = '../../data/eeg_signals_128_sequential_band_all_with_mean_std.pth' #外面的main ../../
        # self.eeg_dataset = '../../data/mask.pth' #外面的main ../../
        ...
        self.best_test_model_dir = '/home/mly/PycharmProjects/weizhan-eeg/egg/code/TEarea_FT_Transformer/draw_check/time'
